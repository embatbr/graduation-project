...
\newcommand{\sectionrefTWO}[2]{Sections \ref{sec:#1} and \ref{sec:#2}}
...
\gdef\defensedate{\today}%{June 10, 2015}
...
\input{chapters/results-verify-ssgmm}

\input{chapters/results-verify-ssagmm}

\input{chapters/results-verify-ssfgmm}
