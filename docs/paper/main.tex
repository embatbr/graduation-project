...
\gdef\papertitle{Fractional Gaussian Mixture Model for Speaker Verification}
...
\chapter*{Declaration}
This paper is a presentation of my original research work, as partial fulfillment of the requirement for the bachelor's degree in Computer Engineer. Wherever contributions of others are involved, every effort is made to indicate this clearly, with due reference to the literature, and acknowledgement of collaborative research and discussions.
\vskip\baselineskip
\noindent The work was done under the guidance of Professor Tsang Ing Ren, at Centro de Informática, Universidade Federal de Pernambuco, Brazil.
