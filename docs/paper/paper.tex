...
\gdef\papertype{Final Project in Computer Engineering}
...
\chapter*{Declaration}
This monograph is a presentation of my research work, as partial fulfillment of the requirement for the degree in Computer Engineering. Wherever contributions of others are involved, every effort is made to indicate this clearly, with due reference to the literature, and acknowledgement of collaborative research and discussions.
\vskip\baselineskip
...
\vskip2\baselineskip
\noindent In my capacity as supervisor of the candidate’s monograph, I certify that the above statements are true to the best of my knowledge.
...
\vskip2\baselineskip
\noindent In my capacity as revisor of the candidate’s monograph, I certify that the above statements are true to the best of my knowledge.
