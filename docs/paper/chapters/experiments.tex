...
This chapter describes the experiments performed on the system described in the previous chapters, contemplating from the front-end processes until the speaker modeling and the log-likelihood ratio test (see \emph{Score} function, \equationref{score_of_X}). First, a description of the corpus is made. Later, the results are exhibit using the feature extraction process and the GMM-UBM techniques.
