...
\begin{equation}
    \postprob{\mathcal{S}}{\boldsymbol{Y}} = \postpdf{\boldsymbol{Y}}{\mathcal{S}}.
...
\begin{figure}[ht]
    ...
    \caption{Speech signal from utterance ``karen livescu", from the corpus defined in \refbib{Woo, Park \& Hazen}{woo.park.hazen.2006}.}
