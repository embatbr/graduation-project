...
\autocite{davis.mermelstein.1980}, \qut{the usual objectives in selecting a representation
...
\autocite{wolf.1972} the ideal features should:
...
level \autocite{pinheiro.2013}. Short-time spectral features are usually calculated
...
\autocite{rabiner.schafer.2007}. As shown in \figureref{loudness}, a 100 Hz tone
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.65]{loudness}
    \caption{\captiontext{Loudness level for human hearing \autocite{fletcher.munson.1933}.}}
    \label{fig:loudness}
\end{figure}
...
Decades after the creation of the mel scale, O'Shaughnessy \autocite{oshaughnessy.1987}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.5]{mel_scale}
    \caption{\captiontext{The logarithm curve of the mel-frequency.}}
    \label{fig:mel_scale}
\end{figure}
