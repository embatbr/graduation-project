...
% Bugs/Suggestions
% (1) Can approximate correlation coefficient as correlation of magnitude
%     squared instead of using a CART
% (2) Incompatible dimensions error in line 103: vs=sum(v.*(2*v+4*m.^2),2)-8*v.*m*z'+4*v*z.^2'; 

%      Copyright (C) Mike Brookes 2014
%      Version: $Id: gaussmixm.m 5624 2015-01-12 12:15:34Z dmb $
%
